...
public interface Graph {
  /**
   * Retourne un tableau modifiable (sans influence sur le graphe) des sommets adjacents au sommet donné en paramètre.
   *
   * @param v Un sommet
  ...
  /**
   * <p>Tableau modifiable (sans impacter le graphe) des arêtes du graphe.</p>
   *
